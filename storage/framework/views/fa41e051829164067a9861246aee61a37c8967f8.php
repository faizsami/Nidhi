...
<head>
    ...
    <title>Techinspire- <?php echo $__env->yieldContent('page_name'); ?></title>
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img src="<?php echo e(asset('assets/images/portrait/small/avatar-s-15.jpg')); ?>" alt="avatar" width="32" height="32"></div>
                                    </div>
                                ...
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img src="<?php echo e(asset('assets/images/portrait/small/avatar-s-3.jpg')); ?>" alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="media-body">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John Doe</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="<?php echo e(asset('assets/images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">MDN NIDHI</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" <?php echo e($active[1] == 'dashboard' ? 'active' : ''); ?> nav-item"> <a class="d-flex align-items-center" href="<?php echo e('/admin/dashboard'); ?>"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1">2</span></a>

                </li>



                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="mail"></i><span class="menu-title text-truncate" data-i18n="Email">Employment</span></a>
                <ul class="menu-content">
                        <li class="<?php echo e($active[1] == 'createemp' ? 'active' : ''); ?>"><a class="d-flex align-items-center" href="<?php echo e('/admin/create-emp'); ?>">
                        <i data-feather="circle"></i><span class="menu-item text-truncate" h data-i18n="Analytics">Add Eployee</span>
                      </a>
                        </li>
                        <li class="<?php echo e($active[1] == 'createbranch' ? 'active' : ''); ?>"><a class="d-flex align-items-center" href="<?php echo e('/admin/add-branch'); ?>">
                        <i data-feather="circle"></i><span class="menu-item text-truncate" h data-i18n="Analytics">Add New Branch</span></a>
                        </li>
...
<?php /**PATH E:\Laravel\Nidhi\resources\views/layouts/admin.blade.php ENDPATH**/ ?>